...
class SkeletonInitModule(Module):
    """
    该模块用于初始化论文/文档的大纲（Skeleton），包括单批次大纲生成和多批次大纲拼接。
    """
    ...
    def forward(self, survey: Survey):
        """
        主流程：
        1. 将 survey.digests 按 batch_size 分批
        2. 对每一批调用 outline_neuron 生成大纲
        3. 如果有多批，则用 concat_neuron 拼接所有大纲
        4. 更新 survey 的 skeleton
        """
