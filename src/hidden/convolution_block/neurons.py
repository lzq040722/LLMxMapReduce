...
class ConvolutionKernelNeuron(Neuron):
    ...
    def forward(
        ...
        对多个反馈建议进行融合，生成新的建议。
        1. 拼接所有建议内容
        2. 组装 prompt，调用大模型融合建议
        3. 解析融合结果，返回新的 Feedback
        """
