...
class AsyncCrawler:
    ...
    def __init__(self, model="gemini-2.0-flash-thinking-exp-1219", infer_type="Google"):
        """
    ...
    async def run(
        ...
        os.environ['http_proxy'] = 'http://wyh:wyh!23.@10.24.116.42:17890'
        os.environ['https_proxy'] = 'http://wyh:wyh!23.@10.24.116.42:17890'
